...
Pong = {
  ...
  Defaults: {
    width:        900,   // logical canvas width (browser will scale to physical canvas size - which is controlled by @media css queries)
    height:       450,   // logical canvas height (ditto)
    wallWidth:    12,
    paddleWidth:  12,
    paddleHeight: 60,
